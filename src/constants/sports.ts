...
export const SPORTS: Sport[] = [
  ...
  { id: 'cricket',         label: 'Cricket',           query: 'cricket IPL',     color: '#3b82f6', bgClass: 'bg-sport-cricket',         textClass: 'text-sport-cricket',         borderClass: 'border-sport-cricket' },
  ...
  { id: 'ncaa-basketball', label: 'College Basketball', query: 'ncaa-basketball', color: '#fbbf24', bgClass: 'bg-sport-ncaa-basketball', textClass: 'text-sport-ncaa-basketball', borderClass: 'border-sport-ncaa-basketball' },
  ...
  { id: 'boxing',          label: 'Boxing',            query: 'boxing',          color: '#a855f7', bgClass: 'bg-sport-boxing',          textClass: 'text-sport-boxing',          borderClass: 'border-sport-boxing' },
];
